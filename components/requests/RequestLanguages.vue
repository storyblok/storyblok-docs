<script>
import Vue from 'vue'
import RequestJavaScript from '@/components/requests/RequestJavaScript'
import RequestBash from '@/components/requests/RequestBash'
import RequestPhp from '@/components/requests/RequestPhp'
