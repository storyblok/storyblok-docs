...
| `resolve_assets` | If the value is `1` it will resolve assets in the content and include the meta information (only available in the [Business](https://www.storyblok.com/pricing) plan and above) |
