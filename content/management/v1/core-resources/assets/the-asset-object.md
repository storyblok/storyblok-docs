...
| `publish_at` | Used to schedule publishing date and time for private assets (Format: `YYYY-mm-dd HH:MM`). Can we `null` if the publishing date hasn’t been scheduled |
