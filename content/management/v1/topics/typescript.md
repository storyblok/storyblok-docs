...
| `put`        | ISbP2Params        | `PUT`    |
| `delete`     | _No params needed_ | `DELETE` |

_Note: `ISbP2Params` is used for `post` and `put` requests._
...
Note that we imported <strong>`ISbP2Params`</strong> and the <strong>`Activities`</strong> interfaces. <br />
...
_Note: <strong>Only</strong> these interfaces will be allowed to be used with the <strong>`post`</strong> and <strong>`put`</strong> requests_

---

| Interface                                   | Core Resource                                                                           | Alias                         | Import Path           |
| ------------------------------------------- | --------------------------------------------------------------------------------------- | ----------------------------- | --------------------- |
| `ISbContentMAPIStories`                     | [Stories Resource](#core-resources/stories/stories)                                     | `CreateStory`                 | `MAPIStories`         |
...
| `ISbContentMAPICollaboratorAddUsersWithSSO` | [Add Collaborators with SSO Resource](#core-resources/collaborators/add-users-with-sso) | `AddCollaboratorUsersWithSSO` | `MAPICollaborators`   |
| `ISbContentMAPIComponents`                  | [Components Resource](#core-resources/components/components)                            | `Components`                  | `MAPIComponents`      |
| `ISbContentMAPIComponentGroups`             | [Component Groups Resource](#core-resources/component-groups/component-groups)          | `ComponentGroups`             | `MAPIComponentGroups` |
| `ISbAssets`                                 | [Assets Resource](#core-resources/assets/assets)                                        | `Assets`                      | `MAPIAssets`          |
| `ISbAssetFolders`                           | [Assets Folders Resource](#core-resources/asset-folders/asset-folders)                  | `AssetFolders`                | `MAPIAssets`          |
| `ISbContentMAPIDataSources`                 | [Data Sources Resource](#core-resources/datasources/datasources)                        | `DataSources`                 | `MAPIDataSources`     |
| `ISbContentMAPIDataSourceEntries`           | [Data Sources Entries Resource](#core-resources/datasource-entries/datasource-entries)  | `DataSourceEntries`           | `MAPIDataSources`     |
| `ISbContentMAPISpaces`                      | [Spaces Resource](#core-resources/spaces/spaces)                                        | `Spaces`                      | `MAPISpaces`          |
...
| `ISbContentMAPITasks`                       | [Tasks Resource](#core-resources/tasks/tasks)                                           | `Tasks`                       | `MAPITasks`           |
| `ISbContentMAPIApprovals`                   | [Approvals Resource](#core-resources/approvals/approvals)                               | `Approvals`                   | `MAPIApprovals`       |
| `ISbContentMAPIReleaseApprovals`            | [Release Approvals Resource](#core-resources/approvals/create-release-approval)         | `ReleaseApprovals`            | `MAPIApprovals`       |
| `ISbContentMAPIActivities`                  | [Activities Resource](#core-resources/activities/activities)                            | `Activities`                  | `MAPIActivities`      |
| `ISbContentMAPIPresets`                     | [Presets Resource](#core-resources/presets/presets)                                     | `Presets`                     | `MAPIPresets`         |
| `ISbContentMAPIFieldTypes`                  | [Field Types Resource](#core-resources/field-types/field-types)                         | `FieldTypes`                  | `MAPIFieldTypes`      |
| `ISbContentMAPIWorkflowStages`              | [Workflow Stages Resource](#core-resources/workflow-stages/intro)                       | `WorkflowStages`              | `MAPIWorkflowStages`  |
...
| `ISbContentMAPIReleases`                    | [Releases Resource](#core-resources/releases/intro)                                     | `Releases`                    | `MAPIReleases`        |
| `ISbContentMAPIPipelines`                   | [Pipelines Resource](#core-resources/pipelines/intro)                                   | `Pipelines`                   | `MAPIPipelines`       |
| `ISbContentMAPIPipelineDeployments`         | [Pipelines Deployments Resource](#core-resources/pipelines/pipeline-deployment)         | `PipelineDeployments`         | `MAPIPipelines`       |
| `ISbContentMAPIPresets`                     | [Presets Resource](#core-resources/presets/presets)                                     | `Presets`                     | `MAPIPresets`         |
| `ISbContentMAPIWorkflowStages`              | [Workflow Stages](#core-resources/workflow-stages/intro)                                | `WorkflowStages`              | `MAPIWorkflowStages`  |
...
_Note: <strong>Only</strong> these interfaces will be allowed to be used with the <strong>`get`</strong> requests_<br />
_If no interface is provided for a specific Core Resource, you have to make the request following the instrucions from the Core Resource's Retrieve session, for instance: [Retrieve One Component](#core-resources/components/retrieve-one-component)_
